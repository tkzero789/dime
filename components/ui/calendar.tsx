  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: "absolute left-1 bg-teal-200 hover:bg-teal-200",
        nav_button_next:
          "absolute right-1 bg-teal-200 hover:bg-teal-200 disabled:bg-white",
        ...
        day_selected:
          "bg-[#0d9488] text-primary-foreground hover:bg-[#0d9488] hover:text-primary-foreground focus:bg-[#0d9488] focus:text-primary-foreground",
        day_today: "bg-teal-100 text-secondary-foreground",
        day_outside:
