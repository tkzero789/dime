...
import { BudgetRadicalChart } from "../chart/BudgetRadicalChart";
  ...
  return (
    <div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-y-2 lg:grid-cols-3 lg:gap-4">
        <div className="order-last col-span-2 grid h-fit grid-cols-1 gap-y-2 lg:order-first lg:grid-cols-2 lg:gap-4">
          {budgetList?.length > 0
